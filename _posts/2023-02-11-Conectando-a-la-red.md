...
[    4.089459] e1000e 0000:00:1f.6 eth0: (PCI Express:2.5GT/s:Width x1) 70:85:c2:57:86:16
...
Entonces ya sabes cual es la diferencia cuando haces un ```ip addr``` o un ```ls /sys/class/net``` [](https://oldwiki.archive.openwrt.org/doc/networking/network.interfaces) entre **eno1** y [**lo**](https://en.wikipedia.org/wiki/Loopback#Virtual_loopback_interface) (loopback) por ejemplo.
